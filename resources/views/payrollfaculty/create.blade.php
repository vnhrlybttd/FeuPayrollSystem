...
<form action="{{route('PayrollFaculty.store')}}" method="POST">
@csrf
...
<div class="form-group">
    ...
    <select multiple class="form-control" id="exampleFormControlSelect2" name="emp_id">
            @foreach ($payrolltablefaculty as $view)
  ...
  <a class="btn btn-primary" href="{{ route('PayrollFaculty.index') }}"><i class="fas fa-arrow-circle-left"></i>
    Back</a>
