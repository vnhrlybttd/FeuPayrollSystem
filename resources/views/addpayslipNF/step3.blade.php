...
<div class="container-fluid">
    ...
    <form method="POST" action={{ action('AddPayslipNFController@stepFour') }}>
        @csrf
        <section>
            <div class="container-fluid mb-5">
                ...
                <div class="row mb-2 bg-white shadow">
                    <div class="col border border-info">
                        <h3 class="pt-2 text-secondary text-center"><i class="fas fa-calculator text-success"></i> Computation
                        </h3>
                        <hr>
                        ...
                        <div class="border border-primary mt-2">
                            ...
                            <div class="form-group pl-5 pr-5">
                                <input type="text" class="form-control bg-primary text-center text-white"
                                    name="p_monthly_pay" id="monthly_pay" readonly value="0" required>
                            </div>
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="number" class="form-control bg-success text-white"
                                                name="p_total_earnings" id="total_earnings" readonly required value="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="number" class="form-control bg-danger text-white"
                                                name="p_total_deductions" id="total_deductions" readonly required value="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group ml-2">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control bg-primary text-white"
                                                        name="p_first_half_pay" id="first_half_pay" readonly required value="0">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group mr-2">
                                                ...
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border border-primary bg-white"><i
                                                            class="fas fa-ruble-sign text-primary"></i></span>
                                                    <input type="text" class="form-control bg-primary text-white"
                                                        name="p_second_half_pay" id="second_half_pay" readonly required value="0">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mr-3">
                                            <input class="form-control" id="thirteen_month_pay"
                                                name="p_thirteen_month_pay" hidden value="0">
                                        </div>

                                        <div class="form-group mr-3">
                                            <input class="form-control" id="p_total_non_taxable"
                                                name="p_total_non_taxable"  value="0" hidden>
                                        </div>
                            ...
                            <div class="col">
                                <div class="border border-success">
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <small>{{date('M. d',strtotime($from))}}-{{date('M. d, Y',strtotime($to))}}<small
                                                class="text-danger">
                                                ({{$absentTable}}mins)</small></small>
                                        <div class="input-group-prepend">
                                            <span class="input-group-text border border-success bg-white"><i
                                                    class="fas fa-ruble-sign text-success"></i></span>
                                            <input id="hidden_absences" value="{{$absentTable}}" step="any" readonly name="hidden_absences" hidden>
                                            @foreach ($salaryDetails as $sdViews)
                                            <input id="mins_absences" value="{{$sdViews->mins}}" step="any" readonly hidden>
                                            @endforeach
                                            <input type="number"
                                                class="form-control form-control-sm bg-success text-white"
                                                name="p_absences" id="absences" readonly step="any" required value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="number" class="form-control form-control-sm"
                                                name="p_adjustment" id="adjustment" step="any" value="0" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="number"
                                                class="form-control form-control-sm bg-success text-white"
                                                name="p_net_basic" id="net_basic" readonly step="any" required value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            <span class="input-group-text border border-success bg-white"><i
                                                    class="fas fa-ruble-sign text-success"></i></span>
                                            <input type="number" class="form-control form-control-sm"
                                                name="p_honorarium" id="honorarium" step="any" value="0" required>
                                        </div>
                                    </div>

                                    <div class="form-group pl-5 pr-5">
                                    <strong for="exampleInputEmail1">Overtime  <small>{{date('M. d',strtotime($from))}}-{{date('M. d, Y',strtotime($to))}}</small> <small class="text-danger">(M-F)={{$otOne}} (Sat)={{$otTwo}}</small></strong>
                                        <div class="input-group-prepend">
                                            <span class="input-group-text border border-success bg-white"><i
                                                    class="fas fa-ruble-sign text-success"></i></span>
                                            <input type="number" class="form-control form-control-sm bg-success text-white" name="p_overtime"
                                                id="overtime" step="any" value="0">
                                                <input value="{{$otOne}}" id="otOne" name="otOne" hidden>
                                                <input value="{{$otTwo}}" id="otTwo" name="otTwo" hidden>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            id="over_load" step="any" value="{{$sdView->overload}}">
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="number" class="form-control" name="p_hold_salary_pay_out"
                                                id="hold_salary_pay_out" step="any" value="0">
                                        </div>
                                    </div>
                                ...
                                <div class="border border-danger">
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="number"
                                                ...
                                                name="p_sss_contribution" id="sss_contribution" step="any" readonly value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="number"
                                                ...
                                                value="100" readonly name="pagibig_contri_amt">
                                             
                                          
                                            <input placeholder="Additional" class="form-control form-control-sm" id="additional" type="number" name="pagibig_contri_add" value="0"> =
                                            <input  class="form-control form-control-sm bg-danger text-white" id="total" name="p_pagibig_contribution" type="number" readonly value="0">
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            <span class="input-group-text border border-danger bg-white"><i
                                                    class="fas fa-ruble-sign text-danger"></i></span>
                                            <input type="number" class="form-control form-control-sm"
                                                id="sss_loan" step="any" placeholder="Amt." name="sss_loan_amt" value="0">

                                                <input placeholder="No. of Months" class="form-control form-control-sm" id="sss_month_loan" type="number" name="sss_loan_add" value="0"> =
                                                <input  class="form-control form-control-sm bg-danger text-white " id="sss_total_loan" name="p_sss_loan" type="number" readonly value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            <span class="input-group-text border border-danger bg-white"><i
                                                    class="fas fa-ruble-sign text-danger"></i></span>
                                            <input type="number" class="form-control form-control-sm"
                                                 id="pagibig_loan" step="any" placeholder="Amt." name="pagibig_loan_amt" value="0">

                                                <input placeholder="No. of Months" class="form-control form-control-sm" id="pagibig_month_loan" type="number" name="pagibig_loan_add" value="0"> =
                                                <input  class="form-control form-control-sm bg-danger text-white " id="pagibig_total_loan" name="p_pagibig_loan" type="number" readonly value="0">
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="number"
                                                class="form-control form-control-sm bg-danger text-white"
                                                name="p_tax_withheld" id="tax_withheld" step="any" readonly value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            <span class="input-group-text border border-danger bg-white"><i
                                                    class="fas fa-ruble-sign text-danger"></i></span>
                                            <input type="number" class="form-control form-control-sm"
                                                name="p_cash_advance" id="cash_advance" step="any" value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            <span class="input-group-text border border-danger bg-white"><i
                                                    class="fas fa-ruble-sign text-danger"></i></span>
                                            <input type="number" class="form-control form-control-sm"
                                                name="p_christmas_loan" id="christmas_loan" step="any" value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            <span class="input-group-text border border-danger bg-white"><i
                                                    class="fas fa-ruble-sign text-danger"></i></span>
                                            <input type="number" class="form-control form-control-sm"
                                                name="p_retirement_loan" id="retirement_loan" step="any" value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pl-5 pr-5">
                                        ...
                                        <div class="input-group-prepend">
                                            <span class="input-group-text border border-danger bg-white"><i
                                                    class="fas fa-ruble-sign text-danger"></i></span>
                                            <input type="number" class="form-control form-control-sm"
                                                name="p_others_adjustment" id="others_adjustment" step="any" value="0">
                                        </div>
                                    </div>
