        ...
        <table class="table table-borderless text-center border-bottom border-dark">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-right border-dark">{{$view->emp_firstname}} {{$view->emp_lastname}}</td>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <div class="label">{{$view->a_basic}}</div>
            ...
            <thead>
                <tr class="bg-dark text-white">
                    ...
                    <th colspan="2" class="border-right border-white">Amount</th>
