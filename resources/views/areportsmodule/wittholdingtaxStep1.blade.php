...
<body>
    ...
    <div class="row justify-content-between ml-1 mr-1">
        ...
        <form method="POST" action="{{action('ReportsController@wittholdingtaxStep2')}}">
            @csrf
    ...
    <div class="container-fluid shadow bg-white p-5 mb-5">
        ...
        <h3 class="pt-2 text-secondary text-center">
            <i class="fas fa-calendar-alt text-primary"></i> Wittholding Tax for {{date('M. Y',strtotime($dates))}}
        </h3>
        <hr>
