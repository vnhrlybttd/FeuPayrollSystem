...
<div class="container-fluid">
    <div class="shadow bg-white">
            ...
            <h3 class="pt-2 text-secondary text-center">
                ...
                <div class="p-5">
            {!! Form::model($finds, ['method' => 'PATCH','route' => ['FSPayslip.update', $finds->payslip]]) !!}
            ...
            <a class="btn btn-primary" href="{{route('FSPayslip.index')}}"><i class="fas fa-arrow-circle-left"></i> Back</a>
