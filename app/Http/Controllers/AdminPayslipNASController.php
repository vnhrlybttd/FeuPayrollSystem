...
class AdminPayslipNASController extends Controller
{
    /**
    ...
    {   
        ...
        return view('NASPayslip.index',compact('payslip','approved','rejected'));
    }
    ...
    public function show($id)
    {
        ...
        //dd($finds);
        return view('NASPayslip.show',compact('finds'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('NASPayslip.edit',compact('finds'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Alert::success('Success', 'Changed Status Successfully!');

        return redirect()->route('NASPayslip.index');
    }
