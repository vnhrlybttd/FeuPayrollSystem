...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><i class="fa fa-home" style="color:darkgoldenrod">&nbsp;</i><a
                href="{{'/home'}}">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-calendar-alt"></i> Faculty Payroll</li>
    </ol>
</nav>
...
<div class="container-fluid">
    ...
    <a href="{{route('PayrollFaculty.create')}}"><button class="btn btn-primary"><i class="fas fa-calendar-plus"></i>
            Create Payroll</button></a>
    <hr>


    <h3 class="pt-2 text-secondary text-center">
        <i class="fas fa-calendar-alt text-primary"></i> Faculty Payroll
    </h3>
    <hr>

    <div class="table-responsive mb-5">
        <table class="table table-hover table-bordered text-center" id="displayTwo" class="display">
            <thead class="thead-dark">
                <tr>
                    <th>Payroll ID</th>
                    <th>Employee ID</th>
                    <th>Employee Name</th>
                    <th class="bg-success">Salary Details</th>
                    <th>Date</th>
                    <th>Payslips</th>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$view->payrolltablefaculty_id}}</td>
                    <td>{{$view->emp_id}}</td>
                    <td>{{$view->emp_firstname}} {{$view->emp_lastname}}</td>
                    <td>
                        <div class="row text-center">
                            <div class="col">Load Units:</div>
                            <div class="col">{{$view->load_units}}</div>
                        </div>
                        <div class="row text-center">
                            <div class="col">Laboratory Units:</div>
                            <div class="col">{{$view->laboratory_units}}</div>
                        </div>
                        <div class="row text-center">
                            <div class="col">Laboratory Hours:</div>
                            <div class="col">{{$view->laboratory_hours}}</div>
                        </div>
                        <hr>
                        <div class="row text-center">
                            <div class="col bg-success text-white">Total Hours:</div>
                            <div class="col bg-success text-white">{{$view->total_hours}}</div>
                        </div>
                        <hr>
                        <div class="row text-center">
                        ...
                        <div class="row text-center">
                            <div class="col">Rate Per Hour Old:</div>
                            <div class="col">{{$view->rate_per_hour_old}}</div>
                        </div>
                        ...
                        <div class="row text-center">
                            <div class="col">Overload:</div>
                            <div class="col">{{$view->overload}}</div>
                        </div>
                    ...
                    <td><a class="btn btn-info" href="{{ route('PayrollFaculty.show',$view->emp_id) }}"><i class="fas fa-money-check"></i> View Payslips</a></td>
                    <form action="{{ route('PayrollFaculty.destroy',$view->payrolltablefaculty_id) }}" method="post">
                            @csrf
                            @method('DELETE')
