...
<form method="POST" action="{{route('forcepassword')}}">
@csrf
        ...
        <div class="col">
            <div class="shadow p-3">
                ...
                <h3 class="text-secondary text-center">
                    <i class="fas fa-key text-success"></i> Force Change Password
                </h3>
                <hr>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Old Password" name="current_password" type="password" value="FeuCavite123!" hidden>
                </div>
                <div class="form-group">
