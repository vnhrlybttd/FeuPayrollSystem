...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-calendar-alt"></i> Payroll Entry Report</li>
    </ol>
</nav>
<hr>
...
<div class="container-fluid bg-white shadow p-3">
    ...
    <form method="POST" action="{{action('ReportsController@PayrollEntryStep1')}}">
        @csrf


        <input class="form-control" value="Payroll Entry" name="report_name" hidden>
