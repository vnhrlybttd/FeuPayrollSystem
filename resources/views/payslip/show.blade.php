...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><i class="fa fa-home" style="color:darkgoldenrod">&nbsp;</i><a
                href="{{'/home'}}">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-file"></i> Non Faculty Payslip
        </li>
    </ol>
</nav>
<hr>
...
<div class="row mb-1">
        <a href="{{('/payslip')}}"><button class="btn btn-primary ml-3"><i class="fas fa-arrow-circle-left"></i>
           Go Back </button></a>
</div>
