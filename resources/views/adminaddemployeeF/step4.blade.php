...
<form method="POST" action={{ action('AddEmployeeFController@addEmployee') }} onsubmit="document.getElementById('btnSubmit').disabled=true;">
    @csrf
    <section>
...
<hr>
                        ...
                        <div class="col">
                                ...
                                <div class="form-group text-center">
                                        ...
                                        <h5 class="text-primary">{{Session::get('addemployee')->load_units}}</h5>
                                        <div class="label"><strong>Laboratory Total Units</strong></div>
                                        <h5 class="text-primary">{{Session::get('addemployee')->laboratory_units}}</h5>
                                        <div class="label"><strong>Laboratory Total Hours</strong></div>
                                        <h5 class="text-primary">{{Session::get('addemployee')->laboratory_hours}}</h5>
                                        <div class="label"><strong>Total Hours</strong></div>
                                        <h5 class="text-primary">{{Session::get('addemployee')->total_hours}}</h5>
                                        <div class="label"><strong>Rate per Hour</strong></div>
                                        <h5 class="text-primary">{{Session::get('addemployee')->rate_per_hour}}</h5>
                                        <div class="label"><strong>Rate per Hour(old)</strong></div>
                                        <h5 class="text-primary">{{Session::get('addemployee')->rate_per_hour_old}}</h5>
                                        ...
                                        <h5 class="text-primary">{{Session::get('addemployee')->overload}}</h5>
