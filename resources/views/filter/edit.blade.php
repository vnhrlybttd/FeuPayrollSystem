...
{!! Form::model($finds, ['method' => 'PATCH','route' => ['calculateAbsence.update', $finds->faculty_salary]]) !!}
    @csrf
    ...
    <div class="container-fluid bg-white shadow p-5">
            ...
            <h3 class="pt-2 text-secondary text-center">
                ...
                <input class="form-control" value="{{$finds->emp_id}}" name="emp_id" readonly>
                </div>
        ...
        <div class="form-group ml-5 mr-5">
                <a class="btn btn-primary" href="{{route('Faculty.index')}}"><i class="fas fa-arrow-circle-left"></i> Back</a>
