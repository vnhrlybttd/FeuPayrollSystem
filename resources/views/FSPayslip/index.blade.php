...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><i class="fa fa-home" style="color:darkgoldenrod">&nbsp;</i><a
                href="{{'/home'}}">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-file"></i> Faculty Payslip</li>
    </ol>
</nav>
<hr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info"
                                        href="{{ route('FSPayslip.show',[Crypt::encrypt($payslipView->payslip)]) }}"><i
                                            class="fas fa-eye"></i> Payslip Details</a>
                                    <a class="btn btn-success"
                                        href="{{ route('FSPayslip.edit',$payslipView->payslip) }}"><i
