            ...
            <div class="row p-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                'Full-Time','Part-Time'=>'Part-Time','Probationary'=>'Probationary'],null, array('class'=>'form-control','readonly'));
                                !!}
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-5">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$find->rate_per_hour}}" class="form-control bg-primary text-white" name="rate_per_hour"
                        ...
                        <input value="{{$find->total_basic_salary}}" class="form-control bg-primary text-white" name="total_basic_salary"
