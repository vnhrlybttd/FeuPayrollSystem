...
<div class="container-fluid mb-5">
    <div class="border border-secondary">
        <h3 class="pt-2 text-secondary text-center">
            <i class="fas fa-money-check-alt text-primary"></i> Faculty Payslip
        </h3>
        ...
        <div class="row ml-auto">
            ...
            <a href="{{('/payslipFaculty/create')}}"><button class="btn btn-primary ml-3"><i class="fas fa-plus-circle"></i>
                    Add
                    Payslip</button></a>
                ...
                <table class="table table-hover table-bordered text-center" id="displayTwo" class="display nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <a class="btn btn-info" href="{{ route('payslipFaculty.show',[Crypt::encrypt($payslipView->payslip)]) }}"><i class="fas fa-money-check"></i>  View</a></td>
                            <!--ACTIONS-->
                            <td colspan="2">
                                    <form action="{{ route('payslipFaculty.destroy',$payslipView->payslip) }}" method="post">
                                            <a class="btn btn-warning" href="{{action('PayslipPDFController@downloadPDF', $payslipView->payslip)}}" >PDF</a>
                                        <a class="btn btn-primary" href="{{ route('payslipFaculty.edit',[Crypt::encrypt($payslipView->payslip)]) }}"><i class="fas fa-edit"></i> Edit</a>
                                        @csrf
                                        @method('DELETE')
