...
<hr>
<form method="POST" action={{ action('ANFSDstepsController@stepFive') }}>
    @csrf
    <section>
        <div class="container-fluid mb-5">
            ...
            <div class="row mb-2 bg-white shadow-lg">
                <div class="col border border-info">
                    <h3 class="pt-2 text-secondary text-center"><i class="fas fa-receipt text-success"></i> Payslip
                    </h3>
                    <hr>
                    ...
                    <div class="border border-primary mt-2">
                        ...
                        <div class="form-group pl-5 pr-5">
                            <input type="text" class="form-control bg-primary text-center text-white"
                                name="p_monthly_pay" id="monthly_pay" readonly>
                        </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="number" class="form-control bg-success text-white"
                                            name="p_total_earnings" id="total_earnings" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="number" class="form-control bg-danger text-white"
                                            name="p_total_deductions" id="total_deductions" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="form-group ml-2">
                                            ...
                                            <div class="input-group-prepend">
                                                ...
                                                <input type="text" class="form-control bg-primary text-white"
                                                    name="p_first_half_pay" id="first_half_pay" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group mr-2">
                                            ...
                                            <div class="input-group-prepend">
                                                <span class="input-group-text border border-primary bg-white"><i
                                                        class="fas fa-ruble-sign text-primary"></i></span>
                                                <input type="text" class="form-control bg-primary text-white"
                                                    name="p_second_half_pay" id="second_half_pay" readonly>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group mr-3">
                                            <input class="form-control"  id="thirteen_month_pay" name="p_thirteen_month_pay" hidden>
                                        </div>

                                        <div class="form-group mr-3">
                                                <input class="form-control"  id="p_total_non_taxable" name="p_total_non_taxable" hidden>
                                            </div>

                                            <div class="form-group mr-3">
                                                    <input class="form-control"  id="p_taxable_income" name="p_taxable_income" hidden>
                                                </div>
                            ...
                            <div class="border border-success">
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        name="p_basic_pay" id="basic_pay" readonly step="any" value="{{Session::get('anfsd')->total_basic_salary}}">
                                    </div>
                                </div>

                                <div class="form-group pl-5 pr-5">
                                    <strong for="exampleInputEmail1">Absences/Lates</strong> <small>{{date('M. d',strtotime($from))}}-{{date('M. d, Y',strtotime($to))}}</small>
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border border-success bg-white"><i
                                                class="fas fa-ruble-sign text-success"></i></span>
                                        <input type="number" class="form-control form-control-sm bg-success text-white"
                                        name="p_absences" id="absences"  readonly step="any" value="{{$absentTable}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="number" class="form-control form-control-sm" name="p_adjustment"
                                            id="adjustment" step="any" value="0" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border border-success bg-white"><i
                                                class="fas fa-ruble-sign text-success"></i></span>
                                        <input type="number" class="form-control form-control-sm bg-success text-white"
                                            name="p_net_basic" id="net_basic" readonly step="any">
                                    </div>
                                </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="number" class="form-control form-control-sm"
                                            name="p_cost_of_living_allowance" id="cost_of_living_allowance" step="any" value="0">
                                    </div>
                                </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="number" class="form-control form-control-sm" name="p_honorarium"
                                            id="honorarium"  step="any" value="0">
                                    </div>
                                </div>
                            ...
                            <div class="border border-danger">
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="number" class="form-control form-control-sm bg-danger text-white"
                                            name="p_sss_contribution" id="sss_contribution" step="any" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border border-danger bg-white"><i
                                                class="fas fa-ruble-sign text-danger"></i></span>
                                        <input type="number" class="form-control form-control-sm bg-danger text-white"
                                            name="p_pagibig_contribution" id="pagibig_contribution" step="any" value="100" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border border-danger bg-white"><i
                                                class="fas fa-ruble-sign text-danger"></i></span>
                                        <input type="number" class="form-control form-control-sm" name="p_sss_loan"
                                            id="sss_loan" step="any" value="0">
                                    </div>
                                </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="number" class="form-control form-control-sm" name="p_pagibig_loan"
                                            id="pagibig_loan" step="any" value="0">
                                    </div>
                                </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border border-danger bg-white"><i
                                                class="fas fa-ruble-sign text-danger"></i></span>
                                        <input type="number" class="form-control form-control-sm bg-danger text-white"
                                            name="p_tax_withheld" id="tax_withheld" step="any" readonly >
                                    </div>
                                </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="number" class="form-control form-control-sm" name="p_cash_advance"
                                            id="cash_advance" step="any" value="0">
                                    </div>
                                </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border border-danger bg-white"><i
                                                class="fas fa-ruble-sign text-danger"></i></span>
                                        <input type="number" class="form-control form-control-sm"
                                            name="p_retirement_contributon" id="retirement_contributon" step="any" value="0">
                                    </div>
                                </div>
                                ...
                                <div class="form-group pl-5 pr-5">
                                    ...
                                    <div class="input-group-prepend">
                                        <span class="input-group-text border border-danger bg-white"><i
                                                class="fas fa-ruble-sign text-danger"></i></span>
                                        <input type="number" class="form-control form-control-sm"
                                            name="p_others_payable_realty" id="others_payable_realty" step="any" value="0">
                                    </div>
                                </div>
                            </div>
                        </div>
