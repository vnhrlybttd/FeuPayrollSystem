...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><i class="fa fa-home" style="color:darkgoldenrod">&nbsp;</i><a
                href="{{'/home'}}">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-user"></i> Faculty</li>
    </ol>
</nav>
<hr>

<!--
<a class="btn btn-primary" href="{{('/AddEmployeeF/Step1')}}"><i class="fas fa-address-card"></i>
    Add Employee
</a>
<hr>
-->
    ...
    <div class="table-responsive">
        <table class="table table-hover table-bordered text-center" id="myTable" class="display">
            ...
            <tbody>
                            ...
                            <div class="card card-body">
                                <div class="row">
                                    <div class="col">
                                            ...
                                            <hr class="bg-primary">
                                            <div class="h5 text-left"><b>Work Hours:</b> <u>{{$view->load_units}}</u></div>
                                            <div class="h5 text-left"><b>Additional Hours:</b> <u>{{$view->additional_hours}}</u></div>
                                            <div class="h5 text-left"><b>Total Hours:</b> <u>{{$view->total_hours}}</u></div>
                                            <div class="h5 text-left"><b>Rate per Hour:</b> <u>{{$view->rate_per_hour}}</u></div>
                                            <div class="h5 text-left"><b>Rate per Hour (old):</b> <u>{{$view->rate_per_hour_old}}</u></div>
                                            ...
                                            <div class="h5 text-left"><b>Overload:</b> <u>{{$view->overload}}</u></div>
                ...
                <a class="btn btn-primary" href="{{action('AddEmployeeNFController@editF',[Crypt::encrypt($view->add_id)])}}"><i class="fas fa-edit"></i></a>
                </td>
                </tr>
                @endforeach
            </tbody>
