...
<div class="row mb-1">
    <a href="{{('/mypayslip')}}"><button class="btn btn-primary ml-3"><i class="fas fa-arrow-circle-left"></i>
            Go Back </button></a>
</div>

@foreach ($payslip as $findView)
<div class="container-fluid mb-5">
    <div class="row">
        <div class="col border border-info shadow">
            ...
            <div class="row text-center">
                ...
                <div class="col">{{$findView->employee_id}}</div>
            </div>
        ...
        <div class="col border border-success shadow">
            <h3 class="pt-2 text-secondary text-center">
        ...
        <div class="col border border-danger shadow">
            <h3 class="pt-2 text-secondary text-center">
        ...
        <div class="col border border-primary shadow">
            <h3 class="pt-2 text-secondary text-center">
