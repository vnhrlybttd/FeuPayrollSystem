...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-calendar-alt"></i> Monthly Report</li>
    </ol>
</nav>
<hr>
...
<div class="container-fluid bg-white shadow p-3">
    ...
    <form method="POST" action="{{action('ReportsController@monthlyStep1')}}">
        @csrf


        <input class="form-control" value="Monthly Summary" name="report_name" hidden>
