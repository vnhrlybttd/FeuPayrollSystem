...
<div class="container-fluid">
    ...
    <div class="row justify-content-between">
        ...
        <a class="btn btn-primary" href="{{ route('NonFaculty.index') }}"><i class="fas fa-arrow-circle-left"></i>
            Back</a>
...
<hr>
<form method="POST" action={{ route('NonFaculty.store') }}>
    @csrf
<section>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col border border-info">
                <h3 class="pt-2 text-secondary text-center"><i class="fas fa-address-card text-primary"></i> Add Employee
                </h3>
                <hr>
