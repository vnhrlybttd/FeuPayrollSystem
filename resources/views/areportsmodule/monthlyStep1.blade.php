...
<body>
    ...
    <div class="row justify-content-between ml-1 mr-1">
        ...
        <form method="POST" action="{{action('ReportsController@monthlyStep2')}}">
            @csrf
    ...
    <div class="container-fluid shadow bg-white p-5 mb-5">
        ...
        <h3 class="pt-2 text-secondary text-center">
            <i class="fas fa-calendar-alt text-primary"></i> Payroll for {{date('M. Y',strtotime($dates))}}
        </h3>
        <hr>
        ...
        <table class="table table-bordered table-sm text-center">
            <thead>
                <tr>
                    <th colspan="5">
                        <center class="text-dark">MONTHLY PAY</center>
                    </th>
                </tr>
                <tr>
                        <th class="b">ID</th>
            ...
            <tbody>
                @foreach ($month as $monthly)
                    <tr>
                            <td><small>{{$monthly->emp_pin}}</small></td>
                            <td><small>{{$monthly->emp_firstname}} {{$monthly->emp_lastname}}</small></td>
                    <td><small>{{$monthly->p_monthly_pay}}</small></td>
                    <td><small>{{$monthly->p_first_half_pay}}</small></td>
                    <td><small>{{$monthly->p_second_half_pay}}</small></td>
                    </tr>
                @endforeach
            ...
            <tfoot>
                    <tr>
                        <th colspan="2" class="bg-dark text-white"><small>
                                <center>TOTAL</center>
                            </small></th>
